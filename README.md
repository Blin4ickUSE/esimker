...
Команда каждый раз подтягивает последний код с GitHub в `/opt/esimker` и пересобирает контейнеры (если установка уже была — режим обновления).
...
Переопределение: `ESIMKER_INSTALL_DIR=/path`, `ESIMKER_GIT_BRANCH=main`.
